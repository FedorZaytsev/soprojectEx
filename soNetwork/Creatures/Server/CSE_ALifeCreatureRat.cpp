...
//#define CSE_ALIFE_CREATURE_RAT_DEBUG

#include "../../../shared/hook.h"

#ifdef CSE_ALIFE_CREATURE_RAT_DEBUG
	#include "../../../shared/log.h"
	extern CLog* LogHandle;
#endif

struct CSE_ALifeCreatureRat_sync_buffer
{
	FLOAT	unknown[3];
	FLOAT	unknown2[3];
	FLOAT	direction[3];
...
void CSE_ALifeCreatureRat__UPDATE_Write(DWORD pClass,NET_Packet* pack)
{
	...
	CSE_ALifeCreatureRat_sync_buffer* sync_buffer = (CSE_ALifeCreatureRat_sync_buffer*)CustomSyncData_Entity[objectid];
	...
	LogHandle->Write("CSE_ALifeCreatureRat::UPDATE_Write(0x%X,0x%X)",pClass,pack);
	LogHandle->Write("{");
...
void CSE_ALifeCreatureRat__UPDATE_Read(DWORD pClass,NET_Packet* pack)
{
	...
	if(!sync_buffer) 
	{
		sync_buffer = new CSE_ALifeCreatureRat_sync_buffer;
	...
	LogHandle->Write("CSE_ALifeCreatureRat::UPDATE_Read(0x%X,0x%X)",pClass,pack);
	LogHandle->Write("{");
